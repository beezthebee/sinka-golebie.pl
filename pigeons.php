...
<head>
	...
	<link rel="stylesheet" href="db-interfac.css" />
	<link rel="stylesheet" href="pigeons.css" />
...
<body>
	...
	<section class="content">
		...
		<div class="navigation">
			<a href="pigeons.php" class="linker-option" style="width: 50%;">
				<div>Hodowcy</div>
			</a>
					
			<a href="race-results.php" class="linker-option" style="width: 50%;">
				<div>Linie</div>
			</a>
		</div>
		...
		<div class="wrapper">
			...
			<?php
				...
				$_SESSION['table'] = "pigeon";
				include 'display-pigeons.php';
