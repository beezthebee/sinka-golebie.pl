		...
		<div class="wrapper">
			...
			<?php
				...
				try {
					...
					if (!isset($_SESSION['id_race'])) $_SESSION['id_race'] = $_POST['id'];
					$id = $_SESSION['id_race'];
					$result = $connection->query(sprintf("SELECT * FROM loty WHERE ID = '$id'"));
					$row = $result->fetch_assoc();
					
					if (isset($_SESSION['error'])) echo $_SESSION['error'].'<br>';
					unset($_SESSION['error']);
					
					echo '<form action="save-race.php" method="post" class="textholder-news">
